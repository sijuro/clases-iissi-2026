...
import loadCouponModel from './Coupon.js'
...
const Coupon = loadCouponModel(sequelizeSession, Sequelize.DataTypes)

const db = { Restaurant, Order, Product, ProductCategory, RestaurantCategory, User, Coupon }
...
export { Restaurant, Order, Product, ProductCategory, RestaurantCategory, User, Coupon, sequelizeSession }
