    ...
    */
    ...
    await queryInterface.bulkInsert('Users',
      [
        ...
        { firstName: 'Rider 1', lastName: 'Fake 1', email: 'rider1@rider.com', password: bcrypt.hashSync('secret', salt), phone: '+3466677888', address: 'Fake street 123', postalCode: '41001', userType: 'rider', avatar: process.env.AVATARS_FOLDER + '/maleAvatar.png' }
      ], {})
  },
